...
Constants <- data.frame(c(2:31),delta1_n, delta1SE_n, delta2_n, delta2SE_n, delta3_n, delta3SE_n)
names(Constants) <- c("n","Delta1", "Delta1 Std Error", "Delta2", "Delta2 Std Error", "Delta3", "Delta3 Std Error")

write.csv(Constants, "ConstantsNormal.csv")
