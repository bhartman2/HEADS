...
In order to perform stepwise selection, we need to load the library leaps [151](#r2). After loading this library, we use the <code>regsubsets()</code>
